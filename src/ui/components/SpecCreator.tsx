    ...
    return<React.Fragment>
        ...
        >
            {childTypes.map((childType,index)=>{
                return <ChildNode childType={childType} index={index} key ={index}
                                  childTypeSpecs={childTypeSpecs}
                                  specNode={specNode}
                                  setOpen={setOpen}
                                  addTentativeChild={addTentativeChild}
                                  ui={ui}
                />
            })}
        </Menu>
...
const ChildNode = ({childType, index,childTypeSpecs,specNode,setOpen,addTentativeChild,ui}:{
    childType:string,
    index:number,
    childTypeSpecs:{[type:string]:RawSpecTree},
    specNode:Spec,
    setOpen:(open:boolean)=>void,
    addTentativeChild:(childType:string,type?:number)=>void,
    ui:UI
}) => {
